...
class RegisterScreen extends StatelessWidget {
  ...
  const RegisterScreen({required this.customerFormParams, Key? key}) : super(key: key);
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                RegisterFormBuilder(customerFormParams: customerFormParams),
              ],
            ),
          ),
        );
                      ...
                      children: [
                        ...
                        customerFormParams.customerFormType == CustomerFormType.create
                            ? Column(
                                children: [
                                  PrimaryFormField(
                                    hintIcon: _buildFormFieldIcon(Icons.mail, theme.primaryColor),
                                    label: '${"Email".tr} ',
                                    isRequired: true,
                                  ...
                                  config.verticalSpaceMedium(),
                                  PrimaryFormField(
                                    hintIcon: _buildFormFieldIcon(Icons.lock, theme.primaryColor),
                                    isPassword: true,
                                  ...
                                  PrimaryFormField(
                                    ...
                                    validator: (value) {
                                      ...
                                      print("password:${registerParams.password}");
                        ...
                        PrimaryFormField(
                          ...
                          hintIcon: _buildFormFieldIcon(Icons.phone_android, theme.primaryColor),
                        ...
                        PrimaryButton(
                            label: customerFormParams.customerFormType == CustomerFormType.create
                                ? "CREATE AN ACCOUNT"
                                : "UPDATE",
                            onPressed: () {
                              ...
                              if (registerFormKey.currentState?.validate() == true) {
                                customerFormParams.customerFormType == CustomerFormType.create
                                    ...
                                    : Get.find<ProfileController>()
                                        .updateCustomerInfo(context, registerParams);
                              }
                            }),
                      ],
                    );
